...
function Ribbon_exp(i::Int,j::Int,a::Int,b::Int)
    ...
    res = s_matrix(i,a) * s_matrix(j,b) / v(a)^2 / v(b)^2 / v(i)^2 / v(j)^2

    res

end

#println(Ribbon_exp(1,1,1,1))
#println(Ribbon_exp(2,1,2,2))
#println(Ribbon_exp(2,2,2,2))
#println(Ribbon_exp(2,2,3,3))
